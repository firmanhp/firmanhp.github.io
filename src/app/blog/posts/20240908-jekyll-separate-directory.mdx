...
previewImagePath: "/assets/20240908-jekyll-separate-directory/img/github-pages-logo.png"
previewImageAlt: "GitHub Pages logo"
---

:::warning
This blog site is no longer built with Jekyll. I'm leaving this here for archive purposes.
:::
...
![Environment settings](/assets/20240908-jekyll-separate-directory/img/environment-settings.png)
...
![GitHub Pages settings](/assets/20240908-jekyll-separate-directory/img/pages-settings.png)
Pages settings for the repository.
